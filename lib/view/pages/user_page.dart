      ...
      ListView(
        children: <Widget>[
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => (WishBooks())));     // Navegar para a tela de pesquisa
            },
          ),
          ListTile(
            ...
            onTap: () {    
              Navigator.push(context, MaterialPageRoute(builder: (context) => (BooksAnnounced()))); // Navegar para a tela de pesquisa
            },
          ),
          ListTile(
